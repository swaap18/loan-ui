...
describe('AddLoanComponent', ()=>{
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      providers:[AddLoanComponent,FormBuilder,{ provide: LoanService, useClass: MockLoanService },{ provide: Router, useClass: MockLoanService },{ provide: NotificationService, useClass: MockLoanService }],
      imports:[]
    }).compileComponents();
